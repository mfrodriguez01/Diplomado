class PilotsController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @pilot.update
        format.html { redirect_to @pilot, notice: 'Track was successfully updated.' }
  ...
  private
    ...
    def pilot_params
      params.require(:pilot).permit(:name, :last_name, :identification, :telephone, :email, :experience)
    end
end
