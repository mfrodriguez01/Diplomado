...
class AirplanesControllerTest < ActionController::TestCase
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post :create, airplane: { capacity: @airplane.capacity, model: @airplane.model, number: @airplane.number, size: @airplane.size, state: @airplane.state }
    end
  ...
  test "should update airplane" do
    patch :update, id: @airplane, airplane: { capacity: @airplane.capacity, model: @airplane.model, number: @airplane.number, size: @airplane.size, state: @airplane.state }
    assert_redirected_to airplane_path(assigns(:airplane))
  end
